...
Feature: SPDCI string length boundary validation
...
These tests verify boundary conditions are properly enforced.
  ...
  @method=POST @endpoint=registry/search @req=SR-VAL-BND-TXN-01
  ...
  @method=POST @endpoint=registry/search @req=SR-VAL-BND-TXN-02
  ...
  @method=POST @endpoint=registry/search @req=SR-VAL-BND-REF-01
  ...
  @method=POST @endpoint=registry/unsubscribe @req=SR-VAL-BND-SUB-01
  ...
  @method=POST @endpoint=registry/unsubscribe @req=SR-VAL-BND-SUB-02
