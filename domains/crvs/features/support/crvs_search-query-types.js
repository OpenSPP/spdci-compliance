...
Given(/^System wants to search CRVS using expression query$/, function () {
...
Given(/^System wants to search CRVS using predicate query$/, function () {
...
Given(/^System wants to sync search CRVS using expression query$/, function () {
...
Given(/^System wants to sync search CRVS using predicate query$/, function () {
