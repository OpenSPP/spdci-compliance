...
Feature: CRVS Registry signature validation

These scenarios verify SECURITY behavior for message signature validation
as defined by the OpenAPI spec.

  @smoke @method=POST @endpoint=registry/search @req=CRVS-SEC-SIG-RG-ASYNC-SEARCH-01
  ...
  @smoke @method=POST @endpoint=registry/sync/search @req=CRVS-SEC-SIG-RG-SYNC-SEARCH-01
