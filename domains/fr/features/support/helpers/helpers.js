/**
 * FR (Farmer Registry) Compliance Test Helpers
 *
 * Domain-specific configuration and re-exports from common infrastructure.
 * This file provides FR-specific endpoint overrides and re-exports
 * payload factories bound to the 'fr' domain.
 */
...
// ============================================
// FR REQUEST PAYLOADS (delegating to common)
// ============================================
...
// ============================================
// FR ENDPOINTS (using common config with env overrides)
// ============================================

const endpointPrefix = process.env.FR_ENDPOINT_PREFIX ?? 'registry/';

export const searchEndpoint = process.env.FR_SYNC_SEARCH_ENDPOINT || getEndpoint('syncSearch', DOMAIN) || `${endpointPrefix}sync/search`;
export const subscribeEndpoint = process.env.FR_SUBSCRIBE_ENDPOINT || getEndpoint('subscribe', DOMAIN) || `${endpointPrefix}subscribe`;
export const unsubscribeEndpoint = process.env.FR_UNSUBSCRIBE_ENDPOINT || getEndpoint('unsubscribe', DOMAIN) || `${endpointPrefix}unsubscribe`;
export const asyncsearchEndpoint = process.env.FR_SEARCH_ENDPOINT || getEndpoint('asyncSearch', DOMAIN) || `${endpointPrefix}search`;
export const onsearchEndpoint = process.env.FR_ON_SEARCH_ENDPOINT || getEndpoint('onSearch', DOMAIN) || `${endpointPrefix}on-search`;
export const onsubscribeEndpoint = process.env.FR_ON_SUBSCRIBE_ENDPOINT || getEndpoint('onSubscribe', DOMAIN) || `${endpointPrefix}on-subscribe`;
export const onunsubscribeEndpoint = process.env.FR_ON_UNSUBSCRIBE_ENDPOINT || getEndpoint('onUnsubscribe', DOMAIN) || `${endpointPrefix}on-unsubscribe`;
export const txnstatusEndpoint = process.env.FR_SYNC_TXN_STATUS_ENDPOINT || getEndpoint('syncTxnStatus', DOMAIN) || `${endpointPrefix}sync/txn/status`;
export const asynctxnstatusEndpoint = process.env.FR_TXN_STATUS_ENDPOINT || getEndpoint('asyncTxnStatus', DOMAIN) || `${endpointPrefix}txn/status`;
export const ontxnstatusEndpoint = process.env.FR_TXN_ON_STATUS_ENDPOINT || getEndpoint('onTxnStatus', DOMAIN) || `${endpointPrefix}txn/on-status`;
export const notifyEndpoint = process.env.FR_NOTIFY_ENDPOINT || getEndpoint('notify', DOMAIN) || `${endpointPrefix}notify`;
