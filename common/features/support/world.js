...
import {
  ...
  createDisabledRequestPayload,
  createGetDisabilitySupportRequestPayload,
  createGetDisabilityDetailsRequestPayload,
...
class SpdciWorld extends World {
  ...
  _bindPayloadFactories() {
    ...
    this.payloads = {
      ...
      createSearchRequestPayloadWithGraphqlQuery: () => createSearchRequestPayloadWithGraphqlQuery(domain),
      ...
      createDisabledRequestPayload: () => createDisabledRequestPayload(domain),
      createGetDisabilitySupportRequestPayload: () => createGetDisabilitySupportRequestPayload(domain),
      createGetDisabilityDetailsRequestPayload: () => createGetDisabilityDetailsRequestPayload(domain),
